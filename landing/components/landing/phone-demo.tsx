...
export function PhoneDemo() {
  return (
    <Placeholder label="Démo d'appel animée (hero)" className="mx-auto w-full max-w-md">
      <div className="relative flex flex-col gap-4 rounded-xl border bg-card p-5 shadow-[0_20px_60px_-20px_color-mix(in_oklch,var(--foreground),transparent_70%)] sm:p-6">
        <SyntheticTag />
        ...
        <ol className="flex flex-col gap-2.5">
          <li className="self-start max-w-[85%] rounded-2xl rounded-bl-sm bg-muted px-3.5 py-2.5 text-sm">
            <span className="mb-0.5 block text-[10px] font-semibold tracking-wide text-foreground/70 uppercase">Appelant</span>
          ...
          <li className="self-end max-w-[85%] rounded-2xl rounded-br-sm bg-primary px-3.5 py-2.5 text-sm text-primary-foreground">
            <span className="mb-0.5 block text-[10px] font-semibold tracking-wide text-primary-foreground uppercase">Alex · Agent IA</span>
